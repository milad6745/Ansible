سوال بسیار خوبی پرسیدی، چون به یک مفهوم پیشرفته‌تر در انسیبل اشاره می‌کنی: **برگرداندن تغییرات (rollback) در صورت شکست اجرای playbook**. در انسیبل، این موضوع به‌صورت **اتوماتیک** پشتیبانی نمی‌شود، اما می‌تونی با تکنیک‌ها و ساختارهای خاصی این رفتار رو شبیه‌سازی کنی.
